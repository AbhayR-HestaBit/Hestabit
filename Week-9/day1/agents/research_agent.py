...
class ResearchAgent(BaseChatAgent):
    """
    Research Agent
    - Unique role
    ...
    def __init__(self, name: str, model_client: ChatCompletionClient) -> None:
        super().__init__(name, "Research-focused agent that produces research notes only.")
        self._model_client = model_client
        self._system_messages: list[LLMMessage] = [
            SystemMessage(
                content=(
                    "You are the Research Agent.\n"
                    "Your only job is to produce short research notes.\n"
